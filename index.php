...
<html>
  <head>
    ...
    <?php if(stristr($_SERVER['SERVER_NAME'], 'galactico.us')): ?>
    <script>
      // galactico.us
      ...
      ga('create', 'UA-71249747-3', 'auto');
      ga('send', 'pageview');

    </script>
    <?php endif; ?>

    <?php if(stristr($_SERVER['SERVER_NAME'], 'galacti.co')): ?>
    <script>
      // galacti.co
      (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
      (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
  ...
  <body>
    ...
    <footer id="footer">
      <div>
        <p>Timeline design, code &amp; concept &copy;2015<?php if(date('Y') !== "2015"): ?>&ndash;<?php echo date('Y'); ?><?php endif; ?></p>
      </div>
    </footer>
